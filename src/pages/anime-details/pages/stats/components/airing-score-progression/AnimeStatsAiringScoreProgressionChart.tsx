...
const AnimeStatsAiringScoreProgressionChart = ({ nodes }: Props) => {
  const airingTrendList = nodes.filter((item) => item.episode !== null);

  console.log("airing trends list 2", airingTrendList);
...
export default AnimeStatsAiringScoreProgressionChart;
