...
import { getCurrentYear, toUpperCaseFirstChar } from "../../shared/shared.util";
import { getThisSeasonName } from "../../shared/shared.util";
...
const AnimePopularThisSeasonMain = () => {
  ...
  const currenSeason = getThisSeasonName();

  const currentYear = getCurrentYear();

  const tagsList = [
    { key: "seasonYear", value: currentYear.toString() },
    { key: "season", value: currenSeason },
  ];

  const SearchPageExtraParams = [
    { key: "seasonYear", value: currentYear.toString() },
    {
      key: "season",
      value: currenSeason,
  ...
  return (
    ...
    >
      <AnimePageHeader>
        {toUpperCaseFirstChar(currenSeason)} {currentYear} Anime
      </AnimePageHeader>
      <AnimeFilters
        ...
        seasonValue={
          ...
          ) || { label: currenSeason, value: toUpper(currenSeason) }
        }
...
export default AnimePopularThisSeasonMain;
